      ...
      ColumnLayout {
        ...
        RowLayout {
          ...
          Button {
            ...
            onClicked: {
              console.log("[KB] dialog save clicked",
                JSON.stringify({ title: root.actionTitle, key: root.actionKey, cmd: root.actionCommand, oldKey: root.oldKey, isEditing: root.isEditing }))
              root.saved(
                root.actionKey,
                root.actionTitle,
                root.actionCommand,
